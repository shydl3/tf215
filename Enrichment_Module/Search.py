...
def run(searcher, analyzer):
        ...
        similarityToken=open("/home/user/data/Enrichment_Module/DeepCom_JAVA/IR_code_tokens.txt","w")
        similarityDesc=open("/home/user/data/Enrichment_Module/DeepCom_JAVA/IR_code_desc.txt","w")
